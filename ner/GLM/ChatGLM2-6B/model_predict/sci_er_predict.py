...
checkpoint_path = "/data2/fyj2023/project/ChatGLM2-6B/ptuning/output/scire_rawData20240311_2233/adgen-chatglm2-6b-32k-pt-128-2e-2/checkpoint-1000"
...
data_list = []
data_path = '/data2/fyj2023/project/ChatGLM2-6B/ptuning/data/government_procurement/data_sci/test.json'
with open(data_path, 'r') as fr:
    for line in fr.readlines():
        data = eval(line)
        data_list.append(data)

result_path = '/data2/fyj2023/project/ChatGLM2-6B/ptuning/output/scire_rawData20240311_2233/result/result_1000.txt'
