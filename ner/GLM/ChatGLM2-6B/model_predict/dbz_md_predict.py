...
def load_model_on_gpus(checkpoint_path: Union[str, os.PathLike], num_gpus: int = 2,
    ...
    if num_gpus < 2 and device_map is None:
        ...
        prefix_state_dict = torch.load(os.path.join('/data2/fyj2023/project/ChatGLM2-6B/ptuning/output/gov1000_dbz_rawData20240306_1638/adgen-chatglm2-6b-32k-pt-128-2e-2/checkpoint-500/', "pytorch_model.bin"))
