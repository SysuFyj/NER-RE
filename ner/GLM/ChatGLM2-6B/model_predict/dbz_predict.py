...
checkpoint_path = "/data2/fyj2023/project/ChatGLM2-6B/ptuning/output/gov1000_dbz_rawData20240112_1338/adgen-chatglm2-6b-32k-pt-128-2e-2/checkpoint-500"
...
data_list = []
data_path = '/data2/fyj2023/project/ChatGLM2-6B/ptuning/data/government_procurement/dbz_data/test.json'
with open(data_path, 'r') as fr:
    for line in fr.readlines():
        data = eval(line)
        data_list.append(data)

result_path = '/data2/fyj2023/project/ChatGLM2-6B/ptuning/output/gov1000_dbz_rawData20240112_1338/result/result_500.txt'
