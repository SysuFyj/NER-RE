...
# 写入新的json文件
with open('../data/mod/full_data.json', 'w', encoding='utf-8') as f0:
    for line in full_dataset:
        json.dump(line, f0, ensure_ascii=False)
        f0.write('\n')

with open('../data/mod/train.json', 'w', encoding='utf-8') as f1:
    for line in train_set:
        json.dump(line, f1, ensure_ascii=False)
        f1.write('\n')
    
with open('../data/mod/dev.json', 'w', encoding='utf-8') as f2:
   for line in dev_set:
        json.dump(line, f2, ensure_ascii=False)
        f2.write('\n')
   
with open('../data/mod/test.json', 'w', encoding='utf-8') as f3:
