...
if __name__ == '__main__':
    args = parse_args()
    args.schema = ['Method','Task','Material','Metric','Other-ScientificTerm','Generic']
    args.schema_lang = "ch"
    ...
    print(uie("Our contributions include a concise , modular architecture with reversible processes of understanding and generation , an information-state model of reference , and flexible links between semantics and collaborative problem solving ."))
